...
extension UIBezierPath {
    ...
    /// creates and returns a new UIBezierPath object initialized with the text glyphs generated from the specified font.
    static public func bezierPath(with text: String, font: UIFont) -> UIBezierPath {
